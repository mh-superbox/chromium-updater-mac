...
## Report bugs using Github's [issues](https://github.com/mh-superbox/chromium-updater-mac/issues)

GitHub issues are used to track public bugs.
Report a bug by [opening a new issue](https://github.com/mh-superbox/chromium-updater-mac/issues/new/choose);
it's that easy!
